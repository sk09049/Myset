...
<form:form action="addcategory" method="post" commandName="cat" onsubmit="return valform()" >
<div class="row">
<div class="form-group col-xs-offset-4 col-xs-3">
<h3 class="text-primary col-xs-offset-2">Add Categories</h3>
<form:input type="text" class="form-control formInvalid"  placeholder="enter category id"  path="id" id="cat-a1" required="true" onblur="idcheck()"/>
</div>
</div>
<div class="row">
<div class="form-group col-xs-offset-4 col-xs-3">
