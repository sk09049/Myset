...
<a href="updatesupplier"><button  type="button" class=" col-xs-1 btn btn-success" >Update</button></a>

<a href="deletesupplier"><button  type="button" class=" col-xs-1 btn btn-warning" >delete</button></a>
</div>
</form:form>
<script>
function valform(){
